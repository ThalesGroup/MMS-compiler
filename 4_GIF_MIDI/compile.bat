...
rept 0 { ; fi ; ../bin/fasm compile.bat 4.mms ; exit $? #
:WIN
@echo off & ..\bin\FASM.EXE compile.bat 4.mms & pause & exit }
...
l1size = $ - l1
   ...
   if textsize > 0
      db 04h ; Number of contents = 3: t.txt, g.gif, a.mid, smil.smil
      ...
      db 03h ; Number of contents = 2: g.gif, a.mid, smil.smil
   end if
